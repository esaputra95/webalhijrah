...
Panel Admin: Untuk mengelola layanan, pengguna, dan pengajuan kegiatan 2. Memulai Aplikasi
Langkah-langkah:
Buka browser (Chrome, Firefox, Safari, atau Edge)
Akses URL aplikasi (misal: http://localhost:3000)
Halaman dashboard publik akan muncul secara otomatis 3. Halaman Dashboard
...
Data akan terhapus permanen 6. Menu Pengguna
Menu pengguna digunakan untuk mengelola user dan data pimpinan.

Jenis Jabatan:
Gubernur: Pejabat Gubernur
Admin: Administrator sistem
KBRT: Kepala Bagian Rumah Tangga
KBU: Kepala Biro Umum
AKBRT: Admin Kepala Bagian Rumah Tangga
TU: Tata Usaha
...
Saat mengedit pengguna, password tidak dapat diubah melalui form ini. Gunakan fitur "Ubah Password" jika tersedia.

Menghapus Pengguna:
Klik icon Hapus pada baris pengguna
Konfirmasi penghapusan
Data akan terhapus permanen 7. Pengajuan Kegiatan
...
Aksi yang tersedia 8. Update Status Pengajuan
...
Q: Tidak bisa login?
A: Pastikan email dan password benar. Cek CAPS LOCK. Hubungi admin untuk reset password.
