...
export const GET = wrap(
  async (_req: NextRequest, ctx: { params: Promise<{ id: string }> }) => {
    ...
    return setResponse(donation, "Detail Donation (Master)");
  }
);

// ====== PUT /api/donation-master/[id] ======
export const PUT = wrap(
  async (req: NextRequest, ctx: { params: Promise<{ id: string }> }) => {
    ...
    return setResponse(updated, "Donation berhasil diupdate (Master)");
  }
);

// ====== DELETE /api/donation-master/[id] ======
export const DELETE = wrap(
  async (_req: NextRequest, ctx: { params: Promise<{ id: string }> }) => {
    ...
    return setResponse(deleted, "Donation berhasil dihapus (Master)");
  }
);
